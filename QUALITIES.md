...
- Absolute Binding Signatures (number + scheme type 87) — see [Hassan-Wallet](https://github.com/MMKUK/Hassan-Wallet) `hassan-signer`
...
- Embedded glass explorer (blocks, escrow guide, analytics)
...
Honest limits: see [`SECURITY.md`](SECURITY.md). Guides: [`GUIDE-NODE.md`](GUIDE-NODE.md) · [`GUIDE-ESCROW.md`](GUIDE-ESCROW.md). Wallet/signer: [Hassan-Wallet](https://github.com/MMKUK/Hassan-Wallet).
